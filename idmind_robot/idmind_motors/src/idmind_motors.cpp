      ...
      hardstop_blocked_(0), once_(true), green_light_(false)
{
  ...
  params &= ros::param::get(idmind_ns_+"kinematics", kinematics_);
  params &= ros::param::get(idmind_ns_+"wheels", wheels_);
  params &= ros::param::get(idmind_ns_+"wheel_radius", wheel_radius_);
  params &= ros::param::get(idmind_ns_+"base_width", base_width_);

  ros::param::param<double>(idmind_ns_+"max_acc_v", max_acc_v_, 0.5);
  ros::param::param<double>(idmind_ns_+"max_acc_w", max_acc_w_, 2.0);
  ros::param::param<double>(idmind_ns_+"acc_dec_factor", acc_dec_factor_, 5.0);
  ...
  encoders_command_ = 0x4A;
  velocity_command_ = 0x56;
  voltages_command_ = 0x51;
  stop_command_ = 0x57;
